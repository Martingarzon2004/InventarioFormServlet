...
public class RecibeDatos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String pass = request.getParameter("clave");
            ...
            if("administrador".equals(user) && "numerolargo".equals(pass)){
                processRequest(request, response, "<a href=\"Menú principal_1.html\">Registro exitoso. Haz clic aqui para ingresar al menú principal.</a>");
            } else {
            processRequest(request, response, "Registro fallido");
            }
